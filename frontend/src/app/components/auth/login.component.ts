      ...
      <div class="auth-card card">
        ...
        <div *ngIf="!show2FA()">
          <div class="auth-header">
            ...
            <h2>Sign In</h2>
            <p>Sign in to your OrbitOps client portal.</p>
          </div>
          ...
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" novalidate>
            ...
            <div class="form-group">
              ...
              <input 
                ...
                placeholder="client@enterprise.com or admin"
        ...
        <div *ngIf="show2FA()">
          <div class="auth-header">
            ...
            <h2>Enter Code</h2>
            <p style="margin-top: 0.5rem;">We've sent a 6-digit security code to <strong>{{ loginEmail() }}</strong> to verify this session. (Local test files saved in <code>chat_data/emails</code>).</p>
          </div>
